...
export default function SurveyRespondPage() {
  ...
  return (
    <div className="min-h-screen bg-slate-100 px-4 py-6 sm:py-12">
      <div className="mx-auto max-w-2xl rounded-2xl bg-white p-5 shadow-sm ring-1 ring-slate-200 sm:p-8">
